...
export default class AlertPriceLines extends PriceLines {
  ...
  private static createAlertLine = (yValue: number): AlertLinesDatum => ({
    yValue,
    title: `<svg style="transform: scale(0.7) translate(0, -3px);" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
